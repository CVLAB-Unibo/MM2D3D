...
import lib.dataset.virtual_kitti_splits as splits
...
class DummyDataset(Dataset):
    ...
    def glob_frames(self, scenes):
        for scene in scenes:
            glob_path = osp.join(self.root_dir, "vkitti_npy", scene, "*.npy")
...
if __name__ == "__main__":
    root_dir = "data/virtual_kitti"
    out_dir = "data/virtual_kitti/virtual_kitti_preprocess"
